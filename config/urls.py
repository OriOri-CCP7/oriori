...
urlpatterns = [
    ...
    path('', views.hello),
    path('api/user/<str:username>/', views.getUserData),
    ...
    path('api/product/<str:name>/', views.getProductData),
    path('api/newProduct/', views.addNewProduct),
    path('api/editedProduct/<str:name>/', views.editProductData),
    path('api/product/deletion/', views.deleteProductData),
    path('api/store/<str:name>/', views.getStoreData),
    path('api/newStore/', views.addNewStore),
    path('api/editedStore/<str:name>/', views.editStoreData),
